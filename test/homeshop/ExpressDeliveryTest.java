...
class ExpressDeliveryTest {
    ...
    assertEquals( 9.99, delivery.getPrice(), delta: 0.01);

        @Test
        public void Given_ParisAsLocation_WhenGettingDeliveryPrice_ThenGet9e99() {
            Delivery delivery = new ExpressDelivery( "Paris");
            assertEquals( 6.99, delivery.getPrice(), delta: 0.01);
